    ...
    <nav className={`${styles.paddingX} w-full  flex  py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex  justify-between items-center max-w-7xl mx-auto'> 
        ...
        <p className='text-white text-[18px] font-bold cursor-pointer flex'>
          Yashi &nbsp;<span className='sm:block hidden'>
            | Portfolio
          </span>
        </p>
        </Link>
       ...
       <div className='flex sm:hidden flex-1 justify-end items-center'>
        <img src={toggle ? close : menu} alt="menu logo" className='w-[28px] h-[28px] object-contain cursor-pointer' onClick={()=> setToggle(!toggle)}/>
