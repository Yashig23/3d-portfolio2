...
const FeedbackCard = ({testimonial, image, designation, name, company, index })=>{
  return(
    <motion.div variants={fadeIn('','spring', index*0.5, 0.75)} className='bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full'>
      ...
      <div className='m-4 flex justify-between text-center gap-1'>
        <div className='flex-1 flex flex-col'>
          <p className='text-white font-medium text-[16px]'>
            <span className='blue-text-gradient text-[16px]'>@</span>{name}
          </p>
          <p>
